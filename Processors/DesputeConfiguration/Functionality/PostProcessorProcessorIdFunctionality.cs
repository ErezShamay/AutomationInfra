...
using Splitit.Automation.NG.Backend.Services.Processors.DesputeConfiguration.BaseObjects;
...
{
    private const string EndPoint = "/api/v1/disputes-configurations/processor/";
