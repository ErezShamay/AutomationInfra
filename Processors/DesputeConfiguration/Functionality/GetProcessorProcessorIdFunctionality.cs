...
using Splitit.Automation.NG.Backend.Services.Processors.DesputeConfiguration.Response;
using Splitit.Automation.NG.Backend.Services.V3.DefaultValues;

namespace Splitit.Automation.NG.Backend.Services.Processors.DesputeConfiguration.Functionality;

public class GetProcessorProcessorIdFunctionality
{
    private const string EndPoint = "/api/v1/disputes-configurations/reason-codes/processor/";
