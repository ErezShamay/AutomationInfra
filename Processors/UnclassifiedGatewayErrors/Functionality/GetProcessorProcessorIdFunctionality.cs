...
using Splitit.Automation.NG.Backend.Services.Processors.UnclassifiedGatewayErrors.Response;
...
{
    private const string EndPoint = "/api/v1/unclassified-gateway-errors/processor/";
